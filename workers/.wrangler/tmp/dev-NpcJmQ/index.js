...
// .wrangler/tmp/bundle-xMQTMW/checked-fetch.js
...
var thoughtTypeEnum = pgEnum("thought_type", ["inner_thought", "decision", "conversation"]);
...
var WebSocketSession = class {
  ...
  async loadAgentsFromDatabase() {
    try {
      ...
      if (agents2.length === 0) {
        console.log("\u26A0\uFE0F \u6570\u636E\u5E93\u4E2D\u6CA1\u6709\u4EE3\u7406\u6570\u636E\uFF0C\u4F7F\u7528\u9ED8\u8BA4\u4EE3\u7406\u6570\u636E");
      ...
      console.error("\u274C \u4ECE\u6570\u636E\u5E93\u52A0\u8F7D\u4EE3\u7406\u5931\u8D25:", error.message);
  ...
  generateMessageContent(messageIndex) {
    const messages3 = [
      ["\u4F60\u597D\uFF01\u4ECA\u5929\u5929\u6C14\u4E0D\u9519\u5462\u3002", "\u55E8\uFF0C\u5F88\u9AD8\u5174\u9047\u5230\u4F60\uFF01"],
    ...
    const messageGroup = messages3[Math.min(messageIndex, messages3.length - 1)];
    return {
...
// .wrangler/tmp/bundle-xMQTMW/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xMQTMW/middleware-loader.entry.ts
